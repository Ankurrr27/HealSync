      ...
      <div className="flex items-center justify-between p-4 bg-white border-b border-gray-200 shadow-md sticky top-0 z-10">
        <div className="flex items-center space-x-2">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM12 20C7.58 20 4 16.42 4 12C4 7.58 7.58 4 12 4C16.42 4 20 7.58 20 12C20 16.42 16.42 20 12 20ZM12 6C9.79 6 8 7.79 8 10C8 12.21 9.79 14 12 14C14.21 14 16 12.21 16 10C16 7.79 14.21 6 12 6ZM12 12C10.9 12 10 11.1 10 10C10 8.9 10.9 8 12 8C13.1 8 14 8.9 14 10C14 11.1 13.1 12 12 12ZM18.04 16.96C16.78 17.65 15.42 18.23 14 18.66V19.5C14 19.78 13.78 20 13.5 20H10.5C10.22 20 10 19.78 10 19.5V18.66C8.58 18.23 7.22 17.65 5.96 16.96C5.58 17.56 5.25 18.18 5 18.82C6.18 20.25 8.09 21.32 10.15 21.78C10.61 21.89 11.09 21.98 11.58 22.04C11.66 22.06 11.75 22.07 11.83 22.07C11.91 22.07 12 22.07 12.08 22.07C12.16 22.07 12.25 22.06 12.33 22.04C12.82 21.98 13.3 21.89 13.76 21.78C15.82 21.32 17.73 20.25 18.91 18.82C18.66 18.18 18.33 17.56 18.04 16.96ZM12 16C10.29 16 8.79 15.29 7.7 14.16C7.96 14.73 8.27 15.28 8.63 15.8C9.52 16.48 10.7 17 12 17C13.3 17 14.48 16.48 15.37 15.8C15.73 15.28 16.04 14.73 16.3 14.16C15.21 15.29 13.71 16 12 16Z" fill="#3B82F6"/>
            </svg>
